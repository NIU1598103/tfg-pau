...
<template>
    <ActionSection>
        ...
        <template #description>
            Organiza y cierra tu sesión en otros dispositivos.
        </template>

        <template #content>
            <div class="max-w-xl text-sm text-gray-600">
                Esta lista puede no ser exhaustiva, si crees que alguien externo ha entrado a tu sesión, es recomendable que modifiques tu contraseña.
            </div>
            ...
            <div class="flex items-center mt-5">
                <PrimaryButton @click="confirmLogout">
                    Desconectar otros inicios de sesión
            ...
            <DialogModal :show="confirmingLogout" @close="closeModal">
                ...
                <template #content>
                    ...
                    Por favor, escribe tu contraseña para confirmar que quieres cerrar sesión en los demás dispositivos.
